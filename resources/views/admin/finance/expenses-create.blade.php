...
@section('title', 'Add Expense - Lau Paradise Adventures')
@section('description', 'Add a new expense')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">
                        <i class="ri-add-line me-2"></i>Add Expense
                    </h4>
                    ...
                    <form action="{{ route('admin.finance.expenses.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="expense_category" class="form-control @error('expense_category') is-invalid @enderror" value="{{ old('expense_category') }}" placeholder="e.g., Transportation, Accommodation, Meals" required>
