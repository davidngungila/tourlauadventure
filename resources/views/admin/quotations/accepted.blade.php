...
@section('title', 'Accepted Quotations - Lau Paradise Adventures')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">
                        <i class="ri-checkbox-circle-line me-2"></i>Accepted Quotations
                    </h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('admin.bookings.create') }}?quotation_id={{ $quotation->id }}" class="btn btn-sm btn-icon btn-outline-success" title="Create Booking">
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-4">
                                <p class="text-muted mb-0">No accepted quotations</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
