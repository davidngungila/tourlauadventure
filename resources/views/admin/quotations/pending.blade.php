...
@section('title', 'Pending Quotations - Lau Paradise Adventures')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">
                        <i class="ri-time-line me-2"></i>Pending Quotations
                    </h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <button class="btn btn-sm btn-icon btn-outline-warning edit-quotation" data-id="{{ $quotation->id }}" data-bs-toggle="modal" data-bs-target="#editQuotationModal">
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-4">
                                <p class="text-muted mb-0">No pending quotations</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
...
@include('admin.quotations.modals.edit')
