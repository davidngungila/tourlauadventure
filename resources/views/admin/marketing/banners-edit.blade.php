            ...
            <div class="card-body">
                <form id="formBanner" method="POST" action="{{ route('admin.marketing.banners.update', $banner->id) }}">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control" id="image_url" name="image_url" value="{{ old('image_url', $banner->image_url) }}" required />
                            ...
                            <div id="image_preview" class="mt-3">
                                ...
                                <div class="border rounded p-2" style="max-width: 300px;">
                                    <img src="{{ $banner->image_url }}" alt="Preview" class="img-fluid rounded" style="max-height: 200px; width: 100%; object-fit: cover;" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
