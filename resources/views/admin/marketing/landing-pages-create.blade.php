...
@section('description', 'Create a new landing page')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title mb-0">Create Landing Page</h5>
            ...
            <div class="card-body">
                <form id="formLandingPage" method="POST" action="{{ route('admin.marketing.landing-pages.store') }}">
                    @csrf
                    <div class="row g-4">
                        <div class="col-md-12">
