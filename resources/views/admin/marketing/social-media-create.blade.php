...
@section('title', 'Create Social Media Post')
@section('description', 'Create a new social media post')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title mb-0">Create Social Media Post</h5>
            ...
            <div class="card-body">
                <form id="formSocialMedia" method="POST" action="{{ route('admin.marketing.social-media.store') }}">
                    @csrf
                    <div class="row g-4">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating form-floating-outline">
                                <input type="url" class="form-control" id="media_url" name="media_url" value="{{ old('media_url') }}" />
