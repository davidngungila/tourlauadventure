...
@section('description', 'Edit promotional code or discount')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="formPromoCode" method="POST" action="{{ route('admin.marketing.promo-codes.update', $promoCode->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row g-4">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $promoCode->name) }}" required />
                        ...
                        <div class="col-md-12">
                            <div class="form-floating form-floating-outline">
                                <textarea class="form-control" id="description" name="description" rows="3">{{ old('description', $promoCode->description) }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input type="number" step="0.01" min="0" class="form-control" id="discount_value" name="discount_value" value="{{ old('discount_value', $promoCode->discount_value) }}" required />
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input type="number" step="0.01" min="0" class="form-control" id="min_purchase" name="min_purchase" value="{{ old('min_purchase', $promoCode->min_purchase) }}" />
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input type="number" step="0.01" min="0" class="form-control" id="max_discount" name="max_discount" value="{{ old('max_discount', $promoCode->max_discount) }}" />
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input type="number" min="1" class="form-control" id="usage_limit" name="usage_limit" value="{{ old('usage_limit', $promoCode->usage_limit) }}" />
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <select id="applicable_to" name="applicable_to" class="form-select" required>
                                    ...
                                    <option value="all" {{ old('applicable_to', $promoCode->applicable_to) == 'all' ? 'selected' : '' }}>All Products</option>
                                    <option value="tours" {{ old('applicable_to', $promoCode->applicable_to) == 'tours' ? 'selected' : '' }}>Tours Only</option>
                                    <option value="hotels" {{ old('applicable_to', $promoCode->applicable_to) == 'hotels' ? 'selected' : '' }}>Hotels Only</option>
                                    <option value="specific" {{ old('applicable_to', $promoCode->applicable_to) == 'specific' ? 'selected' : '' }}>Specific Items</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input type="date" class="form-control" id="valid_from" name="valid_from" value="{{ old('valid_from', $promoCode->valid_from ? $promoCode->valid_from->format('Y-m-d') : '') }}" />
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input type="date" class="form-control" id="valid_until" name="valid_until" value="{{ old('valid_until', $promoCode->valid_until ? $promoCode->valid_until->format('Y-m-d') : '') }}" />
                        ...
                        <div class="col-md-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" {{ old('is_active', $promoCode->is_active) ? 'checked' : '' }} />
