        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">
                        <i class="ri-add-line me-2"></i>Create Email Template
                    </h4>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.marketing.email-templates.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="key" class="form-control @error('key') is-invalid @enderror" value="{{ old('key') }}" placeholder="e.g., welcome_email" required>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="body_html" id="body_html" class="form-control @error('body_html') is-invalid @enderror" rows="15">{{ old('body_html') }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="body_text" class="form-control @error('body_text') is-invalid @enderror" rows="8">{{ old('body_text') }}</textarea>
