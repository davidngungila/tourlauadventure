...
@section('title', 'Add Activity - Lau Paradise Adventures')
@section('description', 'Add a new activity')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">
                        <i class="ri-add-line me-2"></i>Add Activity
                    </h4>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.homepage.activities.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g., Wildlife Safari" required>
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon') }}" placeholder="e.g., fas fa-binoculars">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="e.g., Game drives, Big Five sightings, and incredible wildlife encounters">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="image_url" id="image_url" class="form-control @error('image_url') is-invalid @enderror" value="{{ old('image_url') }}" placeholder="images/activity.jpg or full URL">
                                ...
                                <div id="image_url_preview" class="mt-2">
                                    @if(old('image_url'))
                                    <img src="{{ str_starts_with(old('image_url'), 'http') ? old('image_url') : asset(old('image_url')) }}" alt="Preview" class="image-preview img-thumbnail">
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Lower numbers appear first. Leave empty for auto-assignment.</small>
                                @error('display_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="ri-save-line me-1"></i>Create Activity
                                </button>
                                <a href="{{ route('admin.homepage.activities') }}" class="btn btn-label-secondary">
                                    Cancel
                                </a>
