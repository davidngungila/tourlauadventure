                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="author_image_url" class="form-control @error('author_image_url') is-invalid @enderror" value="{{ old('author_image_url', $testimonial->author_image_url) }}" placeholder="/storage/gallery/image.jpg or https://example.com/avatar.jpg">
                                ...
                                <div id="author_image_preview" class="mt-2">
                                    @if($testimonial->author_image_url)
                                    @php
                                        $imageUrl = str_starts_with($testimonial->author_image_url, 'http') ? $testimonial->author_image_url : asset($testimonial->author_image_url);
                                    @endphp
                                    <div class="border rounded p-2" style="max-width: 150px;">
                                        <img src="{{ $imageUrl }}" alt="Preview" class="img-fluid rounded-circle" style="width: 80px; height: 80px; object-fit: cover;" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="source" class="form-select @error('source') is-invalid @enderror" required>
                                    <option value="website" {{ old('source', $testimonial->source ?? 'website') == 'website' ? 'selected' : '' }}>Website</option>
                                    <option value="google" {{ old('source', $testimonial->source) == 'google' ? 'selected' : '' }}>Google Reviews</option>
                                    <option value="tripadvisor" {{ old('source', $testimonial->source) == 'tripadvisor' ? 'selected' : '' }}>TripAdvisor</option>
                                    <option value="facebook" {{ old('source', $testimonial->source) == 'facebook' ? 'selected' : '' }}>Facebook</option>
                                    <option value="other" {{ old('source', $testimonial->source) == 'other' ? 'selected' : '' }}>Other</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="url" name="review_url" class="form-control @error('review_url') is-invalid @enderror" value="{{ old('review_url', $testimonial->review_url) }}" placeholder="https://www.google.com/maps/reviews/... or https://www.tripadvisor.com/...">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="review_date" class="form-control @error('review_date') is-invalid @enderror" value="{{ old('review_date', $testimonial->review_date ? $testimonial->review_date->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_verified" id="is_verified" value="1" {{ old('is_verified', $testimonial->is_verified ?? false) ? 'checked' : '' }}>
